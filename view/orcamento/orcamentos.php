            ...
            <ul>
                <table>
                    <tr>
                        ...
                        <th class='acao'>VALOR BRUTO</th>
                        <th class='acao'>DESCONTO</th>
                        <th class='acao'>VALOR FINAL</th>
                        <th class='acao'>AÇÕES</th>
                    </tr>

                    <?php
                        $orcamento = $_SESSION['orcamentos'];
                        for ($x = 0; $x < count($orcamento); $x++) {
                            echo
                            "<tr>
                                <td class='nome'>".$orcamento[$x]['cliente']->nome."</td>
                                <td class='nome'>".$orcamento[$x]['status']."</td>
                                <td class='nome'>R$  ".$orcamento[$x]['valor_t_b']."</td>
