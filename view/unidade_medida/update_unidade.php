...
<body>
    <form action="../../models/unidade_medida/update_unidade.php" method="POST">
        <div class="c-c card formulario">
            ...
            <div id="buttons">
                <button id="back" type="reset" onclick="window.history.back()" type="submit" value="CONFIRMAR">CANCELAR</button>
